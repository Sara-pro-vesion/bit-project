export default function CardDo({ data, onEdit }) {
  return (
    <div className="w-[300px] max-w-full mx-auto bg-white border border-[#C2C2C2] rounded-[20px] overflow-hidden shadow-md shadow-[#C2C2C2] hover:shadow-none">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <button onClick={() => onEdit?.(data)} className="bg-[#1E293B] text-white px-3 py-1 rounded-lg text-lg font-medium hover:shadow-xl transition-shadow duration-300 ease-in-out">
            edit
          </button>
        </div>
      </div>
